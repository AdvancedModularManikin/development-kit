...
<MCUXpresso_SDK_Install>/boards/<board>/usb_examples/usb_host_msd_command/<rtos>/readme.pdf.
For lite version, the files path is:
<MCUXpresso_SDK_Install>/boards/<board>/usb_examples/usb_host_msd_command_lite/<rtos>/readme.pdf.
Note
